...
function Footer({
  logo = "Acme",
  tagline = "Build things people love.",
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-2.5 mb-3">
              ...
              <span className="text-stone-100 font-bold">{logo}</span>
            </div>
            <p className="text-sm leading-relaxed mb-5">{tagline}</p>
            {/* Social icons */}
            <div className="flex items-center gap-3">
              {[
                { label: "Twitter/X", path: "M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.734l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" },
          ...
          {columns.map((col) => (
            <div key={col.heading}>
              ...
              <ul className="space-y-3">
                {col.links.map((l) => (
                  <li key={l.label}>
                    <a href={l.href} className="text-sm hover:text-stone-200 transition-colors">
                      {l.label}
                    </a>
                  </li>
                ))}
